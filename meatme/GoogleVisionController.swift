//
//  GoogleVisionController.swift
//  meatme
//
//  Created by Justin Huang on 2016/11/13.
...
class GoogleVisionController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func PostJSON(_ sender: UIButton) {
        ...
        //        toServerRequest(urlString: "http://139.162.24.178/api/v1/?auth_token=", httpMethod: "POST", contentType: "application/json",token: meatMeSeverToken!)
    }
...
extension GoogleVisionController {
